...
export default function SuggestionSection() {
  return (
    <div class="grid md:grid-cols-2 px-2 gap-3 md:gap-6 mb-10">
      <For each={components}>
        {(component) => (
          <div class="rounded-lg shadow-md overflow-hidden flex items-center border border-gray-200">
            ...
            <div class="w-3/5 p-4 flex flex-col justify-between">
              <div>
                <h3 class="text-lg font-semibold mb-2 truncate whitespace-nowrap overflow-hidden">{component.name}</h3>
                <div class="flex justify-between">
                <p class="text-2xl font-bold mb-2">${component.price}</p>
                <div class="flex items-center mb-4">
                  <svg
                    class="w-7 h-7 text-yellow-400 mr-1"
                    fill="currentColor"
                    viewBox="0 0 20 20"
                  >
