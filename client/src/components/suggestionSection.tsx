...
export default function SuggestionSection() {
  return (
    <div>
      ...
      <div class="grid lg:grid-cols-3 md:grid-cols-2 px-1 gap-6 mb-6 text-gray-700">
        <For each={components}>
          {(component) => (
              ...
              <div class="w-3/5 h-full p-2 flex flex-col justify-evenly">
                <div>
                  ...
                  <div class="flex justify-between">
                    <p class=" text-xl font-bold mb-4">${component.price}</p>
      ...
      <div class="flex space-x-1 max-w-xl mb-12 p-1 mx-auto">
        <button class="flex-1 border border-gray-300 rounded-md bg-zinc-100 hover:bg-white transition-colors flex items-center justify-evenly py-3">
          <h1 class="font-bold">ADD BUILD</h1>
          <img src={amazon} class="h-5 w-h-5" alt="" srcset="" />
        </button>
        <button class="flex-1 border border-gray-300 rounded-md bg-zinc-100 hover:bg-white transition-colors flex items-center justify-evenly py-3">
          <h1 class="font-bold">ADD BUILD</h1>
        ...
        <button class="border border-gray-300 p-2 rounded-md bg-zinc-100 hover:bg-white transition-colors py-3">
          <img src={shop} class="h-5 w-h-5" alt="" />
        </button>
      </div>
    </div>
